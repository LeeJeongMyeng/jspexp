...
<h2>사원정보</h2>
 <form id="frm01" >
   ...
   <table>
     <col width="40%">
      <tr><th>사원명</th>
          <td colspan="2"><input type="text" name="ename" value=""/></td></tr>
      <tr><th>직책명</th>
          <td colspan="2"><input type="text" name="job"value=""/></td></tr>
      <tr><th>급여</th>
          <td><input type="text" name="frSal" value="0" value=""/></td>
          <td><input type="text" name="toSal" value="9999" value=""/></td></tr>
...
<script type="text/javascript">
   /*  function send(){
       //사전에 전송되기 전에 데이터 유형성 check해서 전송
       ...
       //Is not a number? 
        ...
        if((frSalObj.value.trim()=="")||isNaN(toSalObj.value)){
           alert("공백이거나 숫자형 데이터가 아닙니다.")
           frSalObj.value="";
           frSalObj.focus()
           return;// 프로세스 진행 방지
       ...
       alert("공백인경우"+(frSalObj.value.trim()=="") );
