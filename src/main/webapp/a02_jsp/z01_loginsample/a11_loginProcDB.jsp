...
<jsp:useBean id="reqMem" class="jspexp.a13_database.vo.Member"/>
...
2. useBean 클래스 선언으로 통한 요청값 받기
   1) 위 query string에서 id=himan 인 경우
   2) 클래스에 void setId(String id){}
      와 같이 id 요청 키에 해당하는 property(setId ==> id) 동일한 메서드가 선언되어 있으면
      setPass(String pass){}
...
<%--
   받은 id: ${reqMem.id},
   받은 pass: ${reqMem.pass}, <%- reqMem.getId(), reqMem.getPass() -%>
