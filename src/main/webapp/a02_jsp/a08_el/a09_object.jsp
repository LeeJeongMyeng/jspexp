...
<%--
	p02.setName("신길동");
# property
1. 객체단위로 접근이 가능한 public으로 선언된 메서드를 호출할 떄, 사용하는 개념이다.
2. getXXX(),setXXX() 메서드로  property라고한다.
3. property 명의 기준
	get/set메서드에서 get/set을 삭제하고 대문자로 시작하는 메서드명을
	소문자로 변경하여 해당 내용을 property로 지칭한다.
	ex) public void setAge(String s){}
		==> setAge ==> Age ==> age(set property,property)
		public void getLoc(){}
		==> getLoc ==> Loc ==>loc(get property,property loc)
4. property 개념
	1) useBean에서사용
	2) el에서도 사용 ${p01.name} name은 getName()에서드를 호출
 --%>
